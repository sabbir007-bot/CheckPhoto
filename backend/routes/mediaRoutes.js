...
const database = cosmosClient.database('frameodb'); // Adjust if your DB name is different
...
router.delete('/:id', async (req, res) => {
  ...
  try {
    ...
    // Delete the item using id and partition key (adjust if partition key is different)
